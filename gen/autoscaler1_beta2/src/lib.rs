...
//! This documentation was generated from *autoscaler* crate version *0.1.12+20150629*, where *20150629* is the exact revision of the *autoscaler:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
