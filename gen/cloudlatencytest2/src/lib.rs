...
//! This documentation was generated from *cloudlatencytest* crate version *0.1.12+20150508*, where *20150508* is the exact revision of the *cloudlatencytest:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
