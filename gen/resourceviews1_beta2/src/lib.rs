...
//! This documentation was generated from *resourceviews* crate version *0.1.12+20150708*, where *20150708* is the exact revision of the *resourceviews:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
