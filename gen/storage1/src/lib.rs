...
//! This documentation was generated from *storage* crate version *0.1.12+20160210*, where *20160210* is the exact revision of the *storage:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
