...
//! This documentation was generated from *siteVerification* crate version *0.1.12+20151007*, where *20151007* is the exact revision of the *siteVerification:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
