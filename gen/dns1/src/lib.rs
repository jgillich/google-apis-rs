...
//!  * [*create*](struct.ManagedZoneCreateCall.html), [*delete*](struct.ManagedZoneDeleteCall.html), [*get*](struct.ManagedZoneGetCall.html) and [*list*](struct.ManagedZoneListCall.html)
