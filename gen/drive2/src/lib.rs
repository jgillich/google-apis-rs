...
//! This documentation was generated from *drive* crate version *0.1.12+20160222*, where *20160222* is the exact revision of the *drive:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
