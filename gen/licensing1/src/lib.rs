...
//! This documentation was generated from *licensing* crate version *0.1.12+20150901*, where *20150901* is the exact revision of the *licensing:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
