...
//! This documentation was generated from *pubsub* crate version *0.1.12+20151103*, where *20151103* is the exact revision of the *pubsub:v1beta2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
