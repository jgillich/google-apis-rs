...
//! This documentation was generated from *gmail* crate version *0.1.12+20160216*, where *20160216* is the exact revision of the *gmail:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
