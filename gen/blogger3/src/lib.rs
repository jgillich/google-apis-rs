...
//! This documentation was generated from *blogger* crate version *0.1.12+20150422*, where *20150422* is the exact revision of the *blogger:v3* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
