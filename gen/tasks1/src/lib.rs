...
//! This documentation was generated from *tasks* crate version *0.1.12+20141121*, where *20141121* is the exact revision of the *tasks:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
