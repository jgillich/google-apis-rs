...
//! This documentation was generated from *QPX Express* crate version *0.1.12+20140321*, where *20140321* is the exact revision of the *qpxExpress:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
