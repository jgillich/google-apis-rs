...
//! This documentation was generated from *gan* crate version *0.1.12+20130205*, where *20130205* is the exact revision of the *gan:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
...
//!              .start_date_min("eos")
//!              .start_date_max("tempor")
//!              .search_text("sea")
//!              .relationship_status("labore")
//!              .add_promotion_type("ipsum")
//!              .page_token("aliquyam")
//!              .max_results(32)
//!              .link_type("sit")
