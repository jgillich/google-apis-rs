...
//! This documentation was generated from *replicapoolupdater* crate version *0.1.12+20160107*, where *20160107* is the exact revision of the *replicapoolupdater:v1beta1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
