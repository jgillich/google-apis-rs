...
//! This documentation was generated from *doubleclicksearch* crate version *0.1.12+20160217*, where *20160217* is the exact revision of the *doubleclicksearch:v2* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
...
//! let result = hub.reports().get_file("reportId", -21)
//!              .doit();
//! 
//! match result {
//!     Err(e) => match e {
