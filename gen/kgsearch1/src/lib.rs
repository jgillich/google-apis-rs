...
//! This documentation was generated from *kgsearch* crate version *0.1.12+20151215*, where *20151215* is the exact revision of the *kgsearch:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v0.1.12*.
//! 
